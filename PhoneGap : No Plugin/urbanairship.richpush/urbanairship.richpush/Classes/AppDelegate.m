...
//
//  Created by urbanairship on 6/8/12.
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"urbanairship.richpush launchOptions = %@", url);
    }    
...
// only valid if urbanairship.richpush-Info.plist specifies a protocol to handle
